...
<head>
 ...
 body
{
    background: url('resources/images/j1.jpg') fixed;
			...
			<div class="row main">
				...
				<div class="main-login main-center">
					<form class="form-horizontal" method="post" action="#">
						...
						<div class="form-group">
							<label for="email" class="cols-sm-8 control-label">Your Email</label>
							<div class="cols-sm-12">
								<div class="input-group">
						...
						<div class="form-group">
							<label for="username" class="cols-sm-8 control-label">Username</label>
							<div class="cols-sm-12">
								<div class="input-group">
						...
						<div class="form-group">
							<label for="password" class="cols-sm-8 control-label">Password</label>
							<div class="cols-sm-12">
								<div class="input-group">
						...
						<div class="form-group">
							<label for="confirm" class="cols-sm-8 control-label">Confirm Password</label>
