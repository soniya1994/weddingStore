...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
 ...
 <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="resources/images/p7.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="resources/images/wr.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="resources/images/jw2.jpg" alt="">
                                </div>
                            </div>
